    ...
    return (
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="bg-[#1c1917] p-6 rounded-2xl border border-stone-800 shadow-sm">
                    ...
                    <div className="space-y-3">
                        <div>
                            ...
                            <div className="text-stone-200 font-medium">{project.company_name}</div>
                        </div>
                        <div>
                ...
                {/* Timeline Card */}
                <div className="bg-[#1c1917] p-6 rounded-2xl border border-stone-800 shadow-sm md:col-span-2">
                    <h3 className="text-lg font-bold text-white mb-4 flex items-center gap-2">
