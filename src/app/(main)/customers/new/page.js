  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6 animate-in fade-in duration-500 pb-20">
      ...
      <div className="flex items-center gap-4">
        ...
        <h1 className="text-2xl font-bold text-stone-200">New Customer</h1>
      </div>

      <form onSubmit={handleSubmit} className="bg-[#1c1917] rounded-2xl border border-stone-800 shadow-sm overflow-hidden">

        {/* Header Section */}
        <div className="px-8 py-8 border-b border-stone-800 bg-stone-900/50 flex flex-col md:flex-row gap-6 items-start md:items-center justify-between">
        ...
        <div className="p-8 space-y-8">
          ...
          {/* Logo Uploader */}
          <div className="p-6 bg-stone-900/50 rounded-xl border border-dashed border-stone-700">
